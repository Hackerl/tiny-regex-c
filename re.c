...
int re_match(const char *pattern, const char *text, int *matchlength) {
    ...
    return re_matchp(re_compile(pattern, re_compiled, ccl_buf), text, matchlength);
}
...
re_t
re_compile(const char *pattern, regex_t re_compiled[MAX_REGEXP_OBJECTS], unsigned char ccl_buf[MAX_CHAR_CLASS_LEN]) {
